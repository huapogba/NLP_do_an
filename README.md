...
|--------|----|----|-----|------|-------|
| NDCG (bình thường) | 0.66 | 0.80 | 0.82 | 0.83 | 0.83 |
| NDCG (mở rộng embedding)| **0.70** | **0.82** | **0.84** | **0.85** | **0.85** |

### 🔹 Passkey Retrieval – 512 token
| Metric | @1 | @5 | @10 | @100 | @1000 |
|--------|----|----|-----|------|-------|
| NDCG (bình thường) | 0.70 | 0.85 | 0.86 | 0.86 | 0.86 |
| NDCG (mở rộng emneding) | **1.00** | **1.00** | **1.00** | **1.00** | **1.00** |
